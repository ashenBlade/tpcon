    ...
    : IWlanRouterStatusExtractor<WlanNetworkPageStatus, WlanNetworkRouterStatus>
{
    ...
    private static Channel GetChannel(JsArray wlanPara)
    {
        ...
        return new Channel(number is ChannelNumberAuto ? Domain.Wlan.ChannelNumber.Auto :  new ChannelNumber(number), 
                           width is ChannelWidthAuto ? Domain.Wlan.ChannelWidth.Auto : new ChannelWidth(width));
    }
