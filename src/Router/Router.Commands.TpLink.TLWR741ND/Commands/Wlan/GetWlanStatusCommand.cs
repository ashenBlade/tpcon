...
public class GetWlanStatusCommand : WlanQueryCommand
{
    public GetWlanStatusCommand(IWlanConfigurator configurator, TextWriter output, IOutputFormatter formatter)
