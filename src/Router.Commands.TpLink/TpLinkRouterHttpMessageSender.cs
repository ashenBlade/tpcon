...
public class TpLinkRouterHttpMessageSender : IRouterHttpMessageSender
{
    private readonly IJsVariableExtractor _jsVariableExtractor;
    private readonly HttpClient _client;

    public TpLinkRouterHttpMessageSender(IJsVariableExtractor jsVariableExtractor, HttpClient client, RouterParameters routerParameters)
    {
